...
7. Open getReferenceGends.R. On line 14, replace the template API key to define genderAPI_key with your free gender-api account. See this page: https://gender-api.com/en/account/overview#my-api-key
